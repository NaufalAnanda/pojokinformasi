...
import { k as komposterImg } from "./sosialisasi-GUJXWM01.mjs";
import { A as ArrowRight, d as ArrowLeft } from "../_libs/lucide-react.mjs";
...
function Beranda() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4 py-10 md:py-16 flex flex-col gap-12 md:gap-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Carousel, { plugins: [Autoplay({
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] md:aspect-[21/9] w-full bg-green-500", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full items-center justify-center font-semibold text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: komposterImg, alt: "Sosialisasi Tong Komposter", className: "h-full w-full object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 w-full bg-gradient-to-t from-black/90 via-black/50 to-transparent px-6 pb-6 pt-16 text-white md:px-10 md:pb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm opacity-90 md:text-base", children: "Sosialisasi Tong Komposter" }) })
      ] }) })
    ] }) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full gap-4 md:grid-cols-3 md:gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/program-kerja", className: "group flex flex-row items-center justify-between rounded-[2rem] bg-[#C1A88D]/30 p-6 transition-all hover:bg-[#C1A88D]/50 hover:shadow-md active:scale-95", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground", children: "Program Kerja" }),
